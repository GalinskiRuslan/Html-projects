...
function init() {
  myMap = new ymaps.Map("map", {
    center: [51.136109, 71.431471],
    zoom: 13,
    controls: [],
  });
  myMap.geoObjects.add(new ymaps.Placemark([51.136109, 71.431471]));
}
ymaps?.ready(init);

function changeFirst() {
  showSlideByIndex(getCurrentSlideInfo().indexOfActive, 0);
}
function changeSec() {
  showSlideByIndex(getCurrentSlideInfo().indexOfActive, 1);
}
function changeThree() {
  showSlideByIndex(getCurrentSlideInfo().indexOfActive, 2);
}
function changeFourth() {
  showSlideByIndex(getCurrentSlideInfo().indexOfActive, 3);
}
function changeFive() {
  showSlideByIndex(getCurrentSlideInfo().indexOfActive, 4);
}
function changeSixth() {
  showSlideByIndex(getCurrentSlideInfo().indexOfActive, 5);
}
function changeSeventh() {
  showSlideByIndex(getCurrentSlideInfo().indexOfActive, 6);
}
function changeEith() {
  showSlideByIndex(getCurrentSlideInfo().indexOfActive, 7);
}
function changeNine() {
  showSlideByIndex(getCurrentSlideInfo().indexOfActive, 8);
}
